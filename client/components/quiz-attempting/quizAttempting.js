/**
 * Created by QASEEM WAKEEL on 9/3/2015.
 */
...
(function() {
    ...
    angular
        .module('app.quizAttempting')
        .controller('QuizAttemptingController', QuizAttemptingController);
    QuizAttemptingController.$inject = ['$location', 'userService', '$timeout', 'quizService', 'QuizAttemptingService'];

    function QuizAttemptingController($location, userService, $timeout, quizService, QuizAttemptingService) {
        var $scope = this;
        ...
        $scope.check12 = function(rule) {
            ...
            if (idx > -1) {
                $scope.rulesArray.splice(idx, 1);
                console.log($scope.rulesArray);
            } else {
                $scope.rulesArray.push(rule);
                console.log($scope.rulesArray);
            }
                    ...
                    abcde.on('child_added', function(dataSnapShot1) {
                        ...
                        abcdef.on('child_added', function(dataSnapShot2) {
                            ...
                            abcdefg.on('child_added', function(dataSnapShot3) {
                                ...
                                QuizAttemptingService.setTotalQuestion($scope.totalQuestion);
                                startTimer(10 * 60);
