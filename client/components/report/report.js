...
(function() {
    'use strict';
    angular.module('app.report', ['core']).controller('ReportController', ['firebaseService', 'dataService', 'userService', '$stateParams', ReportController]);
    
    function ReportController(firebaseService, dataService, userService, $stateParams) {
        var that = this;
