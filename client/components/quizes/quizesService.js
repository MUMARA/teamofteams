    ...
    function quizBank(firebaseService, userService, $q) {
        ...
        _self.loadQuiz = function() {
            ...
            var bookRef = firebaseService.getRefUserQuiz().child(
                userService.getCurrentUser().userID).on('child_added', function(quizUniqueID) {
        ...
        _self.createQuiz = function (quizObject) {
            ...
            var quizUniqueId = firebaseService.getRefUserQuiz().child(
        ...
        _self.loadQuizes = function (userID) {
            ...
            _self.chapters = [];
            _self.chaptersId = [];
            firebaseService.getRefQuestionBvalue.child(questionBankUniqueID).child("chapters").on('value', function (ChaptersUniqueId) {
        ...
        _self.createChapter = function (questionBankUniqueID, chapterObject) {
            firebaseService.getRefQuestionBank().child(questionBankUniqueID).child('chapters').set(chapterObject);
        };
