(function () {
        'use strict';
        angular
            .module('app.projectManagement', ["core"])

            .controller("ProjectManagementController", ["$scope","$log", "$mdSidenav", "$state", "$mdDialog", "$mdMedia", ProjectManagementController]);

        function ProjectManagementController($scope,$log,$mdSidenav, $state, $mdDialog, $mdMedia) {
