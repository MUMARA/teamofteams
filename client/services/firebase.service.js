...
angular.module('core')
    .factory('firebaseService',["$firebaseAuth", "$sessionStorage", "appConfig", "$q", "$location", "$timeout", "messageService", "$firebaseObject", "userPresenceService",'$localStorage',
        ...
        return {
            ...
            getRefMain:  function(){ return ref; },
            getAuthData: function(){ return ref.getAuth(); },
            getRefUsers: function(){ return refUsers; },
            getRefUserGroupMemberships: function(){ return refUserGroupMemberships; },
            getRefUserSubGroupMemberships: function(){ return refUserSubGroupMemberships; },
            getRefUserMicroGroupMemberships: function(){ return refUserMicroGroupMemberships; },
            getRefGroupsUserInvites: function(){ return groupsUserInvites; },
            getRefGroupMembershipRequests: function(){ return groupMembershipRequests; },
            getRefGroupMembershipRequestsByUser: function(){ return groupsMembershipRequestsByUser; },
            getRefSubgroupMembershipRequests: function(){ return subgroupMembershipRequests; },
            getRefSubgroupMembershipRequestsByUser: function(){ return subgroupMembershipRequestsByUser; },
            getRefGroupMembers: function(){ return groupMembers; },
            getRefSubGroupMembers: function(){ return subgroupMembers; },
            getRefMicroGroupMembers: function(){ return microgroupMembers; },
            getRefGroupsNames: function(){return groupsNames; },
            getRefSubGroupsNames: function(){return subgroupsNames; },
            getRefMicroGroupsNames: function(){return microgroupsNames; },
            getRefGroupsActivityStreams: function(){return groupsActivityStreams;},
            getRefSubGroupsActivityStreams: function(){return subgroupsActivityStreams;},
            getRefMicroGroupsActivityStreams: function(){return microgroupsActivityStreams;},
            getRefGroups: function(){ return refGroups; },
            getRefSubGroups: function(){ return refSubGroups; },
            getRefMicroGroups: function(){ return refMicroGroups; },
            getRefGroupCheckinCurrent: function(){ return groupCheckinCurrent; },
            getRefGroupCheckinRecords: function(){ return groupCheckinRecords; },
            getRefGroupLocsDefined: function(){ return groupLocsDefined; },
            getSignedinUserRef: function(){return loggedUserRef},
            getSignedinUserObj: function(){return $loggedUserObj},
            getRefFlattendGroups: function(){return flattenedGroups},
            ...
            asyncCheckIfGroupExists: function(groupID) {
                ...
                groupsNames.child(groupID).once('value', function(snapshot) {
                    ...
                    deferred.resolve({exists: exists, group: snapshot.val()});
                });
                return deferred.promise;
            },
            asyncCheckIfUserExists: function(userID) {
                ...
                refUsers.child(userID).once('value', function(snapshot) {
                    var exists = (snapshot.val() !== null);
                    deferred.resolve({exists: exists, userID: userID, user: snapshot.val()});
                });
                return deferred.promise;
            }
