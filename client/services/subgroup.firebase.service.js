    ...
    .factory('subgroupFirebaseService',['checkinService', "$firebaseArray", "firebaseService", "$q", "$timeout", "$sessionStorage", "$firebaseObject",'userFirebaseService','groupFirebaseService','$localStorage',
        ...
        return {
            getSubgroupSyncObjAsync: function(groupID, subgroupID, viewerUserID){
                ...
                var self = this;
                var syncObj = {subgroupsSyncArray: [], membersSyncArray: [], pendingMembershipSyncArray: [], activitiesSyncArray: [],  groupMembersSyncArray : [] };
            ...
            subgroupUserMembershipAdded: function(snapshot){
                ...
                $timeout(function() {
                    self.push({userID: snapshot.key(), membershipType: snapshot.val()["membership-type"],
            ...
            syncSubgroupActivities: function(groupID, subgroupID, activitiesSyncArray){
                ...
                ref.on("child_added", this.groupActivityAdded, {array: activitiesSyncArray, groupID: groupID, subgroupID: subgroupID, self: this});
                return ref;
            },
