...
function setBuckPicturePath (bucketType, key, fileType){
    var bucketFilePath;
    switch (bucketType){
        case 'user': bucketFilePath = config.userProfilePicture + '/' + key + '.' + fileType;break;
        case 'group':bucketFilePath = config.groupProfilePicture + '/' + key + '.' + fileType;break;
        case 'subgroup':bucketFilePath = config.subgroupProfilePicture+ '/' + key + '.' + fileType;break;
        case 'quizbank':bucketFilePath = config.quizbankProfilePicture+ '/' + key + '.' + fileType;break;
    }
...
function setUrl (bucketType, filename){
    var bucketFilePath;
    switch (bucketType){
        case 'user': bucketFilePath = config.userProfilePicture + '/' + filename;break;
        case 'group':bucketFilePath = config.groupProfilePicture + '/' + filename ;break;
        case 'subgroup':bucketFilePath = config.subgroupProfilePicture+ '/' + filename ;break;
        case 'quizbank':bucketFilePath = config.quizbankProfilePicture+ '/' + filename ;break;
    }
    return bucketFilePath
